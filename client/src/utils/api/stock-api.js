...
export const searchSymbol = async (query) => {
  const url = `${basePath}/search?q=${query}&token=cknju1hr01qrbal99jh0cknju1hr01qrbal99jhg`;
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile2?symbol=${stockSymbol}&token=cknju1hr01qrbal99jh0cknju1hr01qrbal99jhg`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}&token=cknju1hr01qrbal99jh0cknju1hr01qrbal99jhg`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (
  ...
  const url = `${basePath}/stock/candle?symbol=${stockSymbol}&resolution=${resolution}&from=${from}&to=${to}&token=cknju1hr01qrbal99jh0cknju1hr01qrbal99jhg`;
  const response = await fetch(url);
